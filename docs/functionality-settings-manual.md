...
Add a post to a series with a string in front matter:
...
- **Desktop primary links**: `components/Header.tsx` (Home / About / Series / Archive).
- **Mobile hamburger links**: `data/headerNavLinks.ts` (Home / About / Series / Archive,
  followed by Search; Tags is omitted).
...
| `/series/`                | Series index                                                   |
| `/series/[series]/`       | One Series reading page, ordered oldest to newest              |
...
- `sitemap.xml` — home, `/archive/`, `/tags/`, `/series/`, every concrete Series page, both
