...
- The font gate fetches assignment, core, and epoch base artifacts from `origin/main` (`--base-assignments`, `--base-core`, `--base-epoch`); core history is always checked when available, while assignment history is intentionally skipped after an epoch advance.
