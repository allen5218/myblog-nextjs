...
| Shared hover/focus control accent across article pager, Back to top, and KBar results/label | [`unified-control-accent.spec.ts`](../../tests/playwright/unified-control-accent.spec.ts), [`blog-parity.spec.ts`](../../tests/playwright/blog-parity.spec.ts) for the search active result |
