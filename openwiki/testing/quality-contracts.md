...
| Series index/detail routes, sitemap, article entry points, light/dark contrast, **post-hero Series metadata matching Posted/Updated at 375px and 1200px**, and **desktop** primary-navigation order | [`series.spec.ts`](../../tests/playwright/series.spec.ts) |
