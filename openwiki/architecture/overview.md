...
- [`layouts/HuxListLayout.tsx`](../../layouts/HuxListLayout.tsx) renders the home/tag listing surfaces with hero, cards, a list pager, and sidebar. [`layouts/PostLayout.tsx`](../../layouts/PostLayout.tsx) renders hero metadata, article body, mobile TOC, desktop catalog, the adjacent-post pager, and lazily loaded comments. The post layouts put an eligible series link after the article and before the pager; the hero places it after update/date metadata.
